...
describe('express-formidable', () => {
  ...
  // FIXME Mocha does not come equipped with spies, consider migrate to jest
  describe('express-formidable', () => {
    const route = '/events';
    ...
    app.post(route, formidable(null, events), req => callback(req));

    it('parses multipart/form-data with files and recieve all events', (done) => {
      numberOfFields = 0;
